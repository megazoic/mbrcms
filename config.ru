...
Unreloader = Rack::Unreloader.new(subclasses: %w'Roda Sequel::Model', logger: logger, reload: dev){Mbrcms}
require_relative 'models'
Unreloader.require('app.rb'){'Mbrcms'}
run(dev ? Unreloader : Mbrcms.freeze.app)
